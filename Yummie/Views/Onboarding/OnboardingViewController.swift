...
//  Yummie
//
//  Created by Aleyna Isikdaglilar [Ing Teknoloji A.S.-Tuzel Bankacilik Dijital Squad 1] on 1.01.2024.
//
...
private extension OnboardingDataModel {
    static let PromoArray = [
        OnboardingDataModel(imageName: "slide2", title: "remote_advice_corp_promotional_subtitle_1", description: "remote_advice_corp_promotional_desc_1"),
        OnboardingDataModel(imageName: "slide1", title: "remote_advice_corp_promotional_subtitle_2", description: "remote_advice_corp_promotional_desc_2"),
        OnboardingDataModel(imageName: "slide3", title: "remote_advice_corp_promotional_subtitle_3", description: "remote_advice_corp_promotional_desc_3")
    ]}
...
final class OnboardingViewController: UIViewController {
    ...
    private lazy var nextButton: UIButton = {
        ...
        button.cornerRadius = CGFloat(10.0)
        return button
    }()
...
//        guard currentPage < RemoteAdviceCorpPromotionalDataModel.PromoArray.count - 1 else {
//            return
//        }
...
//        collectionView.heightAnchor.constraint(equalTo: safeGuide.heightAnchor, multiplier: 1.0).isActive = true
...
//        nextButton.topAnchor.constraint(equalTo: pageControl.bottomAnchor, constant: 40).isActive = true
//        nextButton.trailingAnchor.constraint(equalTo: safeGuide.trailingAnchor).isActive = true
//        nextButton.leadingAnchor.constraint(equalTo: safeGuide.leadingAnchor).isActive = true
