...
//        w 110 h 200
        ...
        popularImageView.leadingAnchor.constraint(equalTo: stackViewVertical.leadingAnchor, constant: 2).isActive = true
        popularImageView.trailingAnchor.constraint(equalTo: stackViewVertical.trailingAnchor, constant: -2).isActive = true
        popularImageView.topAnchor.constraint(equalTo: popularTitleLabel.bottomAnchor, constant: 2).isActive = true
        popularImageView.bottomAnchor.constraint(equalTo: popularCaloriesLabel.topAnchor, constant: -2).isActive = true
