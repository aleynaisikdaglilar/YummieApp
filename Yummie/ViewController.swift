...
private extension OnboardingDataModel {
    ...
    //        OnboardingDataModel(imageName: "slide2", title: "title_1", description: "description_1"),
    //        OnboardingDataModel(imageName: "slide1", title: "title_2", description: "description_2"),
    //        OnboardingDataModel(imageName: "slide3", title: "title_3", description: "description_3")
    //    ]}
